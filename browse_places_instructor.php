...
// Create equipment tables if they don't exist (same as in browse_places.php)
...
<head>
    ...
    <title>Browse Places - Instructor Portal</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="page-subtitle">Find and apply for places posted by companies</p>
        </div>
        ...
        <div class="results-header">
            ...
            <a href="my_place_applications.php" class="btn btn-secondary">
                    ...
                    <div class="place-card">
                        ...
                        <div class="place-content">
                            ...
                            <div class="place-actions">
                                <a href="place_details_instructor.php?id=<?php echo $place['place_id']; ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye"></i>
                                    View Details
                                </a>
                                <a href="apply_place_instructor.php?id=<?php echo $place['place_id']; ?>" class="btn btn-success btn-sm">
