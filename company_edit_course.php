...
// Get course details
$stmt = $conn->prepare("SELECT * FROM courses WHERE id = ? AND created_by_type = 'company' AND created_by_id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($title) || empty($description) || empty($duration) || empty($mode) || empty($category) || empty($start_date) || empty($end_date)) {
        ...
        // Update course
        $sql = "UPDATE courses SET title = ?, description = ?, duration = ?, mode = ?, category = ?, start_date = ?, end_date = ?, instructor_id = ?, location = ?, requirements = ?, learning_outcomes = ?, certificate_option = ?, status = ?, updated_at = NOW() 
                WHERE id = ? AND created_by_type = 'company' AND created_by_id = ?";
        
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssssssssiii", $title, $description, $duration, $mode, $category, $start_date, $end_date, $instructor_id, $location, $requirements, $learning_outcomes, $certificate_option, $status, $course_id, $company_id);
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-input form-textarea" 
                              placeholder="Describe the course content, objectives, and what students will learn" required><?php echo htmlspecialchars($course['description']); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="mode" name="mode" class="form-select" required>
                        ...
                        <option value="Online" <?php echo ($course['mode'] === 'Online') ? 'selected' : ''; ?>>Online</option>
                        <option value="Onsite" <?php echo ($course['mode'] === 'Onsite') ? 'selected' : ''; ?>>Onsite</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" class="form-select" required>
                        ...
                        <option value="technical" <?php echo ($course['category'] === 'technical') ? 'selected' : ''; ?>>Technical</option>
                        ...
                        <option value="soft_skills" <?php echo ($course['category'] === 'soft_skills') ? 'selected' : ''; ?>>Soft Skills</option>
                        <option value="certification" <?php echo ($course['category'] === 'certification') ? 'selected' : ''; ?>>Certification</option>
                        <option value="workshop" <?php echo ($course['category'] === 'workshop') ? 'selected' : ''; ?>>Workshop</option>
                        <option value="seminar" <?php echo ($course['category'] === 'seminar') ? 'selected' : ''; ?>>Seminar</option>
