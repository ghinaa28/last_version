...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($course_title) || empty($course_description) || empty($course_duration)) {
        ...
        $course_image = $course['course_image']; // Keep existing image by default
        ...
        $stmt = $conn->prepare("UPDATE courses SET course_title = ?, course_description = ?, course_category = ?, course_level = ?, course_duration = ?, course_price = ?, currency = ?, is_online = ?, location = ?, max_students = ?, course_image = ?, course_materials = ?, prerequisites = ?, learning_outcomes = ?, course_schedule = ?, status = ?, is_featured = ? WHERE course_id = ?");
        
        $stmt->bind_param("sssssdssisssssssi", 
            $course_title, 
            $course_description, 
            $course_category, 
            $course_level, 
...
<head>
    ...
    <title>Edit Course - Instructor Portal</title>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="course_description" name="course_description" class="form-textarea" 
                                  placeholder="Describe what students will learn in this course" required><?php echo htmlspecialchars($course['course_description']); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="course_category" name="course_category" class="form-select" required>
                            ...
                            <option value="technical" <?php echo ($course['course_category'] == 'technical') ? 'selected' : ''; ?>>Technical</option>
                            <option value="business" <?php echo ($course['course_category'] == 'business') ? 'selected' : ''; ?>>Business</option>
                            <option value="language" <?php echo ($course['course_category'] == 'language') ? 'selected' : ''; ?>>Language</option>
                            <option value="soft_skills" <?php echo ($course['course_category'] == 'soft_skills') ? 'selected' : ''; ?>>Soft Skills</option>
                            <option value="certification" <?php echo ($course['course_category'] == 'certification') ? 'selected' : ''; ?>>Certification</option>
                            <option value="workshop" <?php echo ($course['course_category'] == 'workshop') ? 'selected' : ''; ?>>Workshop</option>
                            <option value="seminar" <?php echo ($course['course_category'] == 'seminar') ? 'selected' : ''; ?>>Seminar</option>
                            <option value="other" <?php echo ($course['course_category'] == 'other') ? 'selected' : ''; ?>>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="course_level" name="course_level" class="form-select" required>
                            ...
                            <option value="beginner" <?php echo ($course['course_level'] == 'beginner') ? 'selected' : ''; ?>>Beginner</option>
                            ...
                            <option value="expert" <?php echo ($course['course_level'] == 'expert') ? 'selected' : ''; ?>>Expert</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="max_students" name="max_students" class="form-input" 
                               value="<?php echo $course['max_students'] ? $course['max_students'] : ''; ?>" 
                    ...
                    <div class="form-group full-width">
                        <div class="form-checkbox">
                            <input type="checkbox" id="is_online" name="is_online" <?php echo $course['is_online'] ? 'checked' : ''; ?>>
                            <label for="is_online">This is an online course</label>
                        </div>
                    </div>

                    <div class="form-group" id="location-group" style="<?php echo $course['is_online'] ? 'display: none;' : ''; ?>">
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="file-upload">
                            ...
                            <label for="course_image" class="file-upload-label">
                                ...
                                <span>Choose new course image (optional)</span>
                            </label>
                        </div>
                        <?php if ($course['course_image']): ?>
                            <div class="current-image">
                                <strong>Current image:</strong> <?php echo basename($course['course_image']); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="course_materials" name="course_materials" class="form-textarea" 
                                  placeholder="List the materials students will need (books, software, etc.)"><?php echo htmlspecialchars($course['course_materials']); ?></textarea>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="learning_outcomes" name="learning_outcomes" class="form-textarea" 
                                  placeholder="What students will be able to do after completing this course"><?php echo htmlspecialchars($course['learning_outcomes']); ?></textarea>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="course_schedule" name="course_schedule" class="form-textarea" 
                                  placeholder="Course schedule, meeting times, deadlines, etc."><?php echo htmlspecialchars($course['course_schedule']); ?></textarea>
                    </div>

                    <div class="form-group full-width">
                        <div class="form-checkbox">
                            <input type="checkbox" id="is_featured" name="is_featured" <?php echo $course['is_featured'] ? 'checked' : ''; ?>>
